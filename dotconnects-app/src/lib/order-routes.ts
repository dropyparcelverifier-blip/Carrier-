...
export const ORDER_ROUTES: OrderRoute[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  // US -> INDIA. The only routes used for new orders.
  //
  // The 55 above are kept for when those lanes open, but nothing picks
  // from them — see ACTIVE_ROUTE_PREFIX below. An order shipped from a
  // New York warehouse was being assigned Melbourne -> Dubai -> Chennai,
  // because pickOrderRoute() chose at random from every route regardless
  // of origin. Roughly 80% of orders showed a departure gateway the
  // parcel had never been near.
  //
  // EVERY ROUTE ENDS AT THE MUMBAI WAREHOUSE. Entry into India can be
  // Delhi, Bengaluru or Chennai — 42 of these do — but the consignment
  // then moves domestically to Navi Mumbai. That leg is where the extra
  // days on the longer routes actually go, which is both true and a
  // better explanation than "a slower aircraft".
  //
  // Only four are non-stop: EWR->BOM, JFK->BOM and EWR->DEL on Air
  // India, EWR->DEL on United. Those are the genuine US-India
  // non-stops; everything else routes via Dubai, Doha, London,
  // Frankfurt, Istanbul or Amsterdam, which is how US freight really
  // reaches India.
  // ═══════════════════════════════════════════════════════════════
  ...
  orderRoute(
    ...
    [
      ...
      ["John F. Kennedy Intl Airport (JFK), NY", 0.1600],
      ["John F. Kennedy Intl Airport (JFK), NY", 0.1950],
      ["Airspace — JFK to BOM nonstop (Air India Cargo)", 0.3950],
      ["Airspace — approaching Mumbai (Air India Cargo)", 0.5900],
      ["Chhatrapati Shivaji Intl Airport (BOM), Mumbai", 0.6400],
      ["Sahar Air Cargo Complex, Mumbai", 0.7000],
      ["Mumbai, India", 0.7550],
  ...
  orderRoute(
    ...
    [
      ...
      ["Indira Gandhi Intl Airport (DEL), Delhi", 0.6400],
      ["Air Cargo Complex, Delhi", 0.7000],
      ["Delhi, India — cleared for onward movement", 0.7550],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.8800],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
    ],
  ...
  orderRoute(
    ...
    [
      ...
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1600],
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1950],
      ["Airspace — EWR to DEL nonstop (United Cargo)", 0.3950],
      ["Airspace — approaching Delhi (United Cargo)", 0.5900],
      ["Indira Gandhi Intl Airport (DEL), Delhi", 0.6400],
      ["Air Cargo Complex, Delhi", 0.7000],
      ["Delhi, India — cleared for onward movement", 0.7550],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.8800],
  ...
  orderRoute(
    ...
    [
      ...
      ["John F. Kennedy Intl Airport (JFK), NY", 0.1450],
      ["John F. Kennedy Intl Airport (JFK), NY", 0.1780],
      ["Airspace — JFK to DEL nonstop (Air India Cargo)", 0.3600],
      ["Airspace — approaching Delhi (Air India Cargo)", 0.5400],
      ["Indira Gandhi Intl Airport (DEL), Delhi", 0.5900],
      ["Air Cargo Complex, Delhi", 0.6900],
      ["Delhi, India — cleared for onward movement", 0.7800],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
    ],
  ...
  orderRoute(
    ...
    [
      ...
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1450],
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1780],
      ["Airspace — EWR to LHR (British Airways Cargo)", 0.3600],
      ["Heathrow (LHR), London — transhipment", 0.5400],
      ["Chhatrapati Shivaji Intl Airport (BOM), Mumbai", 0.5900],
      ["Sahar Air Cargo Complex, Mumbai", 0.6900],
      ["Mumbai, India", 0.7800],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9000],
  ...
  orderRoute(
    ...
    [
      ...
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.5900],
      ["Air Cargo Complex, Bengaluru", 0.6900],
      ["Bengaluru, India — cleared for onward movement", 0.7800],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
    ],
  ...
  orderRoute(
    ...
    [
      ...
      ["Chennai Intl Airport (MAA), Chennai", 0.5900],
      ["Air Cargo Complex, Chennai", 0.6900],
      ["Chennai, India — cleared for onward movement", 0.7800],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
    ],
  ...
  orderRoute(
    ...
    [
      ...
      ["O'Hare Intl Airport (ORD), Chicago", 0.1450],
      ["O'Hare Intl Airport (ORD), Chicago", 0.1780],
      ["Airspace — ORD to FRA (Lufthansa Cargo)", 0.3600],
      ["Frankfurt Intl (FRA) — transhipment", 0.5400],
      ["Chhatrapati Shivaji Intl Airport (BOM), Mumbai", 0.5900],
      ["Sahar Air Cargo Complex, Mumbai", 0.6900],
      ["Mumbai, India", 0.7800],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9000],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, San Francisco, CA", 0.0500],
      ["DotConnects Origin Warehouse, San Francisco, CA", 0.0820],
      ["San Francisco Intl Airport (SFO), CA", 0.1050],
      ["San Francisco Intl Airport (SFO), CA", 0.1450],
      ["San Francisco Intl Airport (SFO), CA", 0.1780],
      ["Airspace — SFO to DXB (Emirates SkyCargo)", 0.3600],
      ["Dubai Intl (DXB) — transhipment", 0.5400],
      ["Chhatrapati Shivaji Intl Airport (BOM), Mumbai", 0.5900],
      ["Sahar Air Cargo Complex, Mumbai", 0.6900],
      ["Mumbai, India", 0.7800],
  ...
  orderRoute(
    ...
    [
      ...
      ["Chennai Intl Airport (MAA), Chennai", 0.5380],
      ["Air Cargo Complex, Chennai", 0.7000],
      ["Chennai, India — cleared for onward movement", 0.8150],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9200],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
    ],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Washington, DC", 0.0500],
      ["DotConnects Origin Warehouse, Washington, DC", 0.0820],
      ["Dulles Intl Airport (IAD), Washington", 0.1050],
      ["Dulles Intl Airport (IAD), Washington", 0.1450],
      ["Dulles Intl Airport (IAD), Washington", 0.1780],
      ["Airspace — IAD to DOH (Qatar Airways Cargo)", 0.3600],
      ["Hamad Intl (DOH), Doha — transhipment", 0.5400],
      ["Chhatrapati Shivaji Intl Airport (BOM), Mumbai", 0.5900],
      ["Sahar Air Cargo Complex, Mumbai", 0.6900],
      ["Mumbai, India", 0.7800],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Boston, MA", 0.0500],
      ["DotConnects Origin Warehouse, Boston, MA", 0.0820],
      ["Logan Intl Airport (BOS), Boston", 0.1050],
      ["Logan Intl Airport (BOS), Boston", 0.1450],
      ["Logan Intl Airport (BOS), Boston", 0.1780],
      ["Airspace — BOS to IST (Turkish Cargo)", 0.3600],
      ["Istanbul Intl (IST) — transhipment", 0.5400],
      ["Chhatrapati Shivaji Intl Airport (BOM), Mumbai", 0.5900],
      ["Sahar Air Cargo Complex, Mumbai", 0.6900],
      ["Mumbai, India", 0.7800],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9000],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Newark, NJ", 0.0450],
      ["DotConnects Origin Warehouse, Newark, NJ", 0.0750],
      ["Newark Liberty Intl Airport (EWR), NJ", 0.0960],
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1320],
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1620],
      ["Airspace — EWR to AMS (KLM Cargo)", 0.3280],
      ["Schiphol (AMS), Amsterdam — transhipment", 0.4920],
      ["Indira Gandhi Intl Airport (DEL), Delhi", 0.5380],
      ["Air Cargo Complex, Delhi", 0.7000],
      ["Delhi, India — cleared for onward movement", 0.8150],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9200],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
    ],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Atlanta, GA", 0.0500],
      ["DotConnects Origin Warehouse, Atlanta, GA", 0.0820],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1050],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1450],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1780],
      ["Airspace — ATL to DOH (Qatar Airways Cargo)", 0.3600],
      ["Hamad Intl (DOH), Doha — transhipment", 0.5400],
      ["Chhatrapati Shivaji Intl Airport (BOM), Mumbai", 0.5900],
      ["Sahar Air Cargo Complex, Mumbai", 0.6900],
      ["Mumbai, India", 0.7800],
  ...
  orderRoute(
    ...
    [
      ...
      ["John F. Kennedy Intl Airport (JFK), NY", 0.1320],
      ["John F. Kennedy Intl Airport (JFK), NY", 0.1620],
      ["Airspace — JFK to LHR (British Airways Cargo)", 0.3280],
      ["Heathrow (LHR), London — transhipment", 0.4920],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.5380],
      ["Air Cargo Complex, Bengaluru", 0.7000],
      ["Bengaluru, India — cleared for onward movement", 0.8150],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9200],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
    ],
  ...
  orderRoute(
    ...
    [
      ...
      ["San Francisco Intl Airport (SFO), CA", 0.1450],
      ["San Francisco Intl Airport (SFO), CA", 0.1780],
      ["Airspace — SFO to DOH (Qatar Airways Cargo)", 0.3600],
      ["Hamad Intl (DOH), Doha — transhipment", 0.5400],
      ["Indira Gandhi Intl Airport (DEL), Delhi", 0.5900],
      ["Air Cargo Complex, Delhi", 0.6900],
      ["Delhi, India — cleared for onward movement", 0.7800],
  ...
  orderRoute(
    ...
    [
      ...
      ["O'Hare Intl Airport (ORD), Chicago", 0.1450],
      ["O'Hare Intl Airport (ORD), Chicago", 0.1780],
      ["Airspace — ORD to IST (Turkish Cargo)", 0.3600],
      ["Istanbul Intl (IST) — transhipment", 0.5400],
      ["Indira Gandhi Intl Airport (DEL), Delhi", 0.5900],
      ["Air Cargo Complex, Delhi", 0.6900],
      ["Delhi, India — cleared for onward movement", 0.7800],
  ...
  orderRoute(
    ...
    [
      ...
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1320],
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1620],
      ["Airspace — EWR to FRA (Lufthansa Cargo)", 0.3280],
      ["Frankfurt Intl (FRA) — transhipment", 0.4920],
      ["Chennai Intl Airport (MAA), Chennai", 0.5380],
      ["Air Cargo Complex, Chennai", 0.7000],
      ["Chennai, India — cleared for onward movement", 0.8150],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9200],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Boston, MA", 0.0450],
      ["DotConnects Origin Warehouse, Boston, MA", 0.0750],
      ["Logan Intl Airport (BOS), Boston", 0.0960],
      ["Logan Intl Airport (BOS), Boston", 0.1320],
      ["Logan Intl Airport (BOS), Boston", 0.1620],
      ["Airspace — BOS to LHR (British Airways Cargo)", 0.3280],
      ["Heathrow (LHR), London — transhipment", 0.4920],
      ["Indira Gandhi Intl Airport (DEL), Delhi", 0.5380],
      ["Air Cargo Complex, Delhi", 0.7000],
      ["Delhi, India — cleared for onward movement", 0.8150],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Washington, DC", 0.0450],
      ["DotConnects Origin Warehouse, Washington, DC", 0.0750],
      ["Dulles Intl Airport (IAD), Washington", 0.0960],
      ["Dulles Intl Airport (IAD), Washington", 0.1320],
      ["Dulles Intl Airport (IAD), Washington", 0.1620],
      ["Airspace — IAD to FRA (Lufthansa Cargo)", 0.3280],
      ["Frankfurt Intl (FRA) — transhipment", 0.4920],
      ["Chhatrapati Shivaji Intl Airport (BOM), Mumbai", 0.5380],
      ["Sahar Air Cargo Complex, Mumbai", 0.7000],
      ["Mumbai, India", 0.8150],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Atlanta, GA", 0.0450],
      ["DotConnects Origin Warehouse, Atlanta, GA", 0.0750],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.0960],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1320],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1620],
      ["Airspace — ATL to DXB (Emirates SkyCargo)", 0.3280],
      ["Dubai Intl (DXB) — transhipment", 0.4920],
      ["Indira Gandhi Intl Airport (DEL), Delhi", 0.5380],
      ["Air Cargo Complex, Delhi", 0.7000],
      ["Delhi, India — cleared for onward movement", 0.8150],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, San Francisco, CA", 0.0450],
      ["DotConnects Origin Warehouse, San Francisco, CA", 0.0750],
      ["San Francisco Intl Airport (SFO), CA", 0.0960],
      ["San Francisco Intl Airport (SFO), CA", 0.1320],
      ["San Francisco Intl Airport (SFO), CA", 0.1620],
      ["Airspace — SFO to DXB (Emirates SkyCargo)", 0.3280],
      ["Dubai Intl (DXB) — transhipment", 0.4920],
      ["Chennai Intl Airport (MAA), Chennai", 0.5380],
      ["Air Cargo Complex, Chennai", 0.7000],
      ["Chennai, India — cleared for onward movement", 0.8150],
  ...
  orderRoute(
    ...
    [
      ...
      ["O'Hare Intl Airport (ORD), Chicago", 0.1320],
      ["O'Hare Intl Airport (ORD), Chicago", 0.1620],
      ["Airspace — ORD to AMS (KLM Cargo)", 0.3280],
      ["Schiphol (AMS), Amsterdam — transhipment", 0.4920],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.5380],
      ["Air Cargo Complex, Bengaluru", 0.7000],
      ["Bengaluru, India — cleared for onward movement", 0.8150],
  ...
  orderRoute(
    ...
    [
      ...
      ["John F. Kennedy Intl Airport (JFK), NY", 0.1320],
      ["John F. Kennedy Intl Airport (JFK), NY", 0.1620],
      ["Airspace — JFK to BOM (Air India Cargo)", 0.3280],
      ["Chhatrapati Shivaji Intl (BOM), Mumbai — transhipment", 0.4920],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.5380],
      ["Air Cargo Complex, Bengaluru", 0.7000],
      ["Bengaluru, India — cleared for onward movement", 0.8150],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9200],
  ...
  orderRoute(
    ...
    [
      ...
      ["Los Angeles Intl Airport (LAX), CA", 0.1320],
      ["Los Angeles Intl Airport (LAX), CA", 0.1620],
      ["Airspace — LAX to IST (Turkish Cargo)", 0.3280],
      ["Istanbul Intl (IST) — transhipment", 0.4920],
      ["Chhatrapati Shivaji Intl Airport (BOM), Mumbai", 0.5380],
      ["Sahar Air Cargo Complex, Mumbai", 0.7000],
      ["Mumbai, India", 0.8150],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9200],
  ...
  orderRoute(
    ...
    [
      ...
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1320],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1620],
      ["Airspace — ATL to DOH (Qatar Airways Cargo)", 0.3280],
      ["Hamad Intl (DOH), Doha — transhipment", 0.4920],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.5380],
      ["Air Cargo Complex, Bengaluru", 0.7000],
      ["Bengaluru, India — cleared for onward movement", 0.8150],
  ...
  orderRoute(
    ...
    [
      ...
      ["Logan Intl Airport (BOS), Boston", 0.1320],
      ["Logan Intl Airport (BOS), Boston", 0.1620],
      ["Airspace — BOS to FRA (Lufthansa Cargo)", 0.3280],
      ["Frankfurt Intl (FRA) — transhipment", 0.4920],
      ["Chennai Intl Airport (MAA), Chennai", 0.5380],
      ["Air Cargo Complex, Chennai", 0.7000],
      ["Chennai, India — cleared for onward movement", 0.8150],
  ...
  orderRoute(
    ...
    [
      ...
      ["Dulles Intl Airport (IAD), Washington", 0.1320],
      ["Dulles Intl Airport (IAD), Washington", 0.1620],
      ["Airspace — IAD to LHR (British Airways Cargo)", 0.3280],
      ["Heathrow (LHR), London — transhipment", 0.4920],
      ["Chennai Intl Airport (MAA), Chennai", 0.5380],
      ["Air Cargo Complex, Chennai", 0.7000],
      ["Chennai, India — cleared for onward movement", 0.8150],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Newark, NJ", 0.0400],
      ["DotConnects Origin Warehouse, Newark, NJ", 0.0660],
      ["Newark Liberty Intl Airport (EWR), NJ", 0.0850],
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1170],
      ["Newark Liberty Intl Airport (EWR), NJ", 0.1430],
      ["Airspace — EWR to BOM (Air India Cargo)", 0.2900],
      ["Chhatrapati Shivaji Intl (BOM), Mumbai — transhipment", 0.4350],
      ["Chennai Intl Airport (MAA), Chennai", 0.4760],
      ["Air Cargo Complex, Chennai", 0.7200],
      ["Chennai, India — cleared for onward movement", 0.8500],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9400],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
    ],
  ...
  orderRoute(
    ...
    [
      ...
      ["Los Angeles Intl Airport (LAX), CA", 0.1170],
      ["Los Angeles Intl Airport (LAX), CA", 0.1430],
      ["Airspace — LAX to AMS (KLM Cargo)", 0.2900],
      ["Schiphol (AMS), Amsterdam — transhipment", 0.4350],
      ["Chennai Intl Airport (MAA), Chennai", 0.4760],
      ["Air Cargo Complex, Chennai", 0.7200],
      ["Chennai, India — cleared for onward movement", 0.8500],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9400],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, San Francisco, CA", 0.0400],
      ["DotConnects Origin Warehouse, San Francisco, CA", 0.0660],
      ["San Francisco Intl Airport (SFO), CA", 0.0850],
      ["San Francisco Intl Airport (SFO), CA", 0.1170],
      ["San Francisco Intl Airport (SFO), CA", 0.1430],
      ["Airspace — SFO to IST (Turkish Cargo)", 0.2900],
      ["Istanbul Intl (IST) — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9400],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 1.0000],
    ],
  ...
  orderRoute(
    ...
    [
      ...
      ["O'Hare Intl Airport (ORD), Chicago", 0.1170],
      ["O'Hare Intl Airport (ORD), Chicago", 0.1430],
      ["Airspace — ORD to LHR (British Airways Cargo)", 0.2900],
      ["Heathrow (LHR), London — transhipment", 0.4350],
      ["Chennai Intl Airport (MAA), Chennai", 0.4760],
      ["Air Cargo Complex, Chennai", 0.7200],
      ["Chennai, India — cleared for onward movement", 0.8500],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9400],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Atlanta, GA", 0.0400],
      ["DotConnects Origin Warehouse, Atlanta, GA", 0.0660],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.0850],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1170],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1430],
      ["Airspace — ATL to FRA (Lufthansa Cargo)", 0.2900],
      ["Frankfurt Intl (FRA) — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
      ["DotConnects Arrival Warehouse, Navi Mumbai", 0.9400],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Boston, MA", 0.0400],
      ["DotConnects Origin Warehouse, Boston, MA", 0.0660],
      ["Logan Intl Airport (BOS), Boston", 0.0850],
      ["Logan Intl Airport (BOS), Boston", 0.1170],
      ["Logan Intl Airport (BOS), Boston", 0.1430],
      ["Airspace — BOS to AMS (KLM Cargo)", 0.2900],
      ["Schiphol (AMS), Amsterdam — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ["dotconnectslogistics.com", 0.0000],
      ["DotConnects Origin Warehouse, Washington, DC", 0.0400],
      ["DotConnects Origin Warehouse, Washington, DC", 0.0660],
      ["Dulles Intl Airport (IAD), Washington", 0.0850],
      ["Dulles Intl Airport (IAD), Washington", 0.1170],
      ["Dulles Intl Airport (IAD), Washington", 0.1430],
      ["Airspace — IAD to IST (Turkish Cargo)", 0.2900],
      ["Istanbul Intl (IST) — transhipment", 0.4350],
      ["Chennai Intl Airport (MAA), Chennai", 0.4760],
      ["Air Cargo Complex, Chennai", 0.7200],
      ["Chennai, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["San Francisco Intl Airport (SFO), CA", 0.1170],
      ["San Francisco Intl Airport (SFO), CA", 0.1430],
      ["Airspace — SFO to LHR (British Airways Cargo)", 0.2900],
      ["Heathrow (LHR), London — transhipment", 0.4350],
      ["Chennai Intl Airport (MAA), Chennai", 0.4760],
      ["Air Cargo Complex, Chennai", 0.7200],
      ["Chennai, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["Los Angeles Intl Airport (LAX), CA", 0.1170],
      ["Los Angeles Intl Airport (LAX), CA", 0.1430],
      ["Airspace — LAX to FRA (Lufthansa Cargo)", 0.2900],
      ["Frankfurt Intl (FRA) — transhipment", 0.4350],
      ["Chennai Intl Airport (MAA), Chennai", 0.4760],
      ["Air Cargo Complex, Chennai", 0.7200],
      ["Chennai, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1170],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1430],
      ["Airspace — ATL to IST (Turkish Cargo)", 0.2900],
      ["Istanbul Intl (IST) — transhipment", 0.4350],
      ["Chennai Intl Airport (MAA), Chennai", 0.4760],
      ["Air Cargo Complex, Chennai", 0.7200],
      ["Chennai, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["Logan Intl Airport (BOS), Boston", 0.1170],
      ["Logan Intl Airport (BOS), Boston", 0.1430],
      ["Airspace — BOS to DOH (Qatar Airways Cargo)", 0.2900],
      ["Hamad Intl (DOH), Doha — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["San Francisco Intl Airport (SFO), CA", 0.1170],
      ["San Francisco Intl Airport (SFO), CA", 0.1430],
      ["Airspace — SFO to AMS (KLM Cargo)", 0.2900],
      ["Schiphol (AMS), Amsterdam — transhipment", 0.4350],
      ["Chennai Intl Airport (MAA), Chennai", 0.4760],
      ["Air Cargo Complex, Chennai", 0.7200],
      ["Chennai, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["Dulles Intl Airport (IAD), Washington", 0.1170],
      ["Dulles Intl Airport (IAD), Washington", 0.1430],
      ["Airspace — IAD to AMS (KLM Cargo)", 0.2900],
      ["Schiphol (AMS), Amsterdam — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["O'Hare Intl Airport (ORD), Chicago", 0.1170],
      ["O'Hare Intl Airport (ORD), Chicago", 0.1430],
      ["Airspace — ORD to FRA (Lufthansa Cargo)", 0.2900],
      ["Frankfurt Intl (FRA) — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1170],
      ["Hartsfield-Jackson Intl Airport (ATL), Atlanta", 0.1430],
      ["Airspace — ATL to LHR (British Airways Cargo)", 0.2900],
      ["Heathrow (LHR), London — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["Logan Intl Airport (BOS), Boston", 0.1170],
      ["Logan Intl Airport (BOS), Boston", 0.1430],
      ["Airspace — BOS to IST (Turkish Cargo)", 0.2900],
      ["Istanbul Intl (IST) — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["Los Angeles Intl Airport (LAX), CA", 0.1170],
      ["Los Angeles Intl Airport (LAX), CA", 0.1430],
      ["Airspace — LAX to LHR (British Airways Cargo)", 0.2900],
      ["Heathrow (LHR), London — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
  ...
  orderRoute(
    ...
    [
      ...
      ["San Francisco Intl Airport (SFO), CA", 0.1170],
      ["San Francisco Intl Airport (SFO), CA", 0.1430],
      ["Airspace — SFO to FRA (Lufthansa Cargo)", 0.2900],
      ["Frankfurt Intl (FRA) — transhipment", 0.4350],
      ["Kempegowda Intl Airport (BLR), Bengaluru", 0.4760],
      ["Air Cargo Complex, Bengaluru", 0.7200],
      ["Bengaluru, India — cleared for onward movement", 0.8500],
...
/**
 * Routes eligible for new orders.
 *
 * Everything DotConnects ships today leaves the US. The non-US routes
 * stay defined so the lanes can be switched on without rebuilding the
 * table, but assigning one to a real order puts a gateway on the
 * customer's timeline that the parcel was never near.
 */
const ACTIVE_ROUTE_PREFIX = "US";

export const ACTIVE_ROUTES: OrderRoute[] = ORDER_ROUTES.filter((r) =>
  r.key.startsWith(ACTIVE_ROUTE_PREFIX),
);

export function pickOrderRoute(): OrderRoute {
  // Never falls back to the full list: an empty ACTIVE_ROUTES would be a
  // build error worth failing loudly on, not something to paper over by
  // silently assigning a Melbourne departure to a Newark parcel.
  return ACTIVE_ROUTES[Math.floor(Math.random() * ACTIVE_ROUTES.length)];
}
...
export function orderRouteStageLocation(
  ...
  if (vendor && VENDOR_STAGES.includes(stage)) {
    ...
    if (stage === "processing") return `DotConnects Origin Warehouse, ${vendor.profile.warehouseCity}, ${vendor.profile.warehouseState}`;
