...
export const STAGE_LOCATIONS: Record<string, string> = {
  ...
  at_vashi_warehouse: "DotConnects Arrival Warehouse, Navi Mumbai",
  qc_check: "DotConnects Arrival Warehouse, Navi Mumbai",
  handed_to_courier: "DotConnects Arrival Warehouse, Navi Mumbai",
};
