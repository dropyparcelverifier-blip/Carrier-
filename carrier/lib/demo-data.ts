...
export const DEMO_SHIPMENTS: Shipment[] = [
  // ── Order 1: In Transit — Newark -> Frankfurt -> Mumbai -> Vashi ──
  {
    ...
    destinationPort: "Destination warehouse, Vashi — Navi Mumbai",
    ...
    events: [
      ...
      { stage: "at_vashi_warehouse",  label: "Received at Vashi warehouse",    location: "Destination warehouse, Navi Mumbai",         timestamp: "",                                                                                          state: "pending" },
      { stage: "qc_check",            label: "Quality check — approved",       location: "Destination warehouse, Navi Mumbai",         timestamp: "",                                                                                          state: "pending" },
    ],
  },
  ...
  // ── Order 3: Received at Vashi — Seattle -> Tokyo -> Mumbai -> Vashi ──
  {
    ...
    events: [
      ...
      { stage: "at_vashi_warehouse",  label: "Received at Vashi warehouse",    location: "Destination warehouse, Navi Mumbai",         timestamp: "16 Jul 2026 · 14:00 IST",  state: "done" },
      { stage: "qc_check",            label: "Quality check — approved",       location: "Destination warehouse, Navi Mumbai",         timestamp: "16 Jul 2026 · 16:30 IST", note: "Quality check passed — preparing last-mile handover.", state: "done" },
      { stage: "handed_to_courier",   label: "Handed to last-mile courier",    location: "Destination warehouse, Navi Mumbai", carrier: "Shiprocket", courierLink: "https://shiprocket.co/tracking/SR8231774920", timestamp: "17 Jul 2026 · 09:15 IST", note: "AWB SR8231774920 — track delivery on Shiprocket's site.", state: "done" },
    ],
  },
];
