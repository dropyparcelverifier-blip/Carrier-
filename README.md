...
The marketing site is content â€” mostly static, SEO lives there, and it was
already built and working. The tracking page and admin panel are an
application, and they are what a customer opens on a phone in India.
...
Separate node_modules, separate .env. They share only the Supabase database â€”
and a copy of the design tokens.
...
The builds matter most: they enumerate every route. A misnamed route file
simply does not appear, and neither tsc nor vitest can see that.
...
under its own root actually changed.
...
Deliberately a copy, not a shared package â€” one maintainer, and a shared
...
`carrier/docs/` holds the phase documents â€” requirements, architecture, plan of
